...
import { Category$inboundSchema } from "../../models/commerce/category.js";
...
export function categoriesGet(
  ...
  Result<
    operations.GetCategoryResponse,
...
> {
  ...
  const path = `/commerce/categories/${safeId}`;
  ...
  const context = {
    ...
    operationID: "commerce.categories.get",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, Category$inboundSchema, {
