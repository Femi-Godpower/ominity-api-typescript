...
import { Invoice$inboundSchema } from "../../models/commerce/invoice.js";
...
> {
    ...
    const path = `/commerce/invoices/${safeId}`;
    ...
    const context = {
        ...
        operationID: "commerce.invoices.get",
        oAuth2Scopes: null,
    ...
    const [result] = await M.match<
        ...
        | SDKValidationError
    >(
        M.json(200, Invoice$inboundSchema, { ctype: "application/hal+json" }),
