...
export function cartItemsCreate(
  client: ClientSDK,
  request: operations.CreateCartItemRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateCartItemResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateCartItemRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "commerce.cart-items.create",
    oAuth2Scopes: null,
  ...
  >(
    ...
    M.json(201, CartItem$inboundSchema, {
      ctype: "application/hal+json",
    }),
