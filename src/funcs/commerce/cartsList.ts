...
import { CartsListResponse$inboundSchema } from "../../models/commerce/cart.js";
...
export function cartsList(
  client: ClientSDK,
  request?: operations.CartsListParams | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListCartsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CartsListParams$outboundSchema.optional().parse(value),
  ...
  const context = {
    ...
    operationID: "commerce.carts.list",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CartsListResponse$inboundSchema, {
