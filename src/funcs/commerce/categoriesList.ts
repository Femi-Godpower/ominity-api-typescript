...
import { CategoriesListResponse$inboundSchema } from "../../models/commerce/category.js";
...
export function categoriesList(
  client: ClientSDK,
  request?: operations.CategoriesListParams | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CategoriesListParams$outboundSchema.optional().parse(value),
  ...
  const path = "/commerce/categories";
  ...
  const context = {
    ...
    operationID: "commerce.categories.list",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CategoriesListResponse$inboundSchema, {
