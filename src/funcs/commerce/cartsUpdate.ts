...
export function cartsUpdate(
  client: ClientSDK,
  request: operations.UpdateCartRequest,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateCartRequest$outboundSchema.parse(value),
  ...
  const path = `/commerce/carts/${safeId}`;
  ...
  const context = {
    ...
    operationID: "commerce.carts.update",
    oAuth2Scopes: null,
